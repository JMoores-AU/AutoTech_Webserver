# T1 Tools Client Setup - Testing Guide
...
2. Type: `t1vnc://10.110.21.87:5900`
3. Press Enter
...
**Test Other URIs:**
```
t1putty://mms@10.110.19.107:22
t1winscp://mms:password@10.110.19.107:22
```
...
**Setup:**
- 2-3 PCs with T1 Tools Client installed
...
**Test Steps:**
1. On a PC WITHOUT T1 Tools Client installed
2. Try to launch VNC
3. Click custom URI

**Expected:**
- Browser shows "Unknown protocol" error
- Terminal shows: "If the application didn't launch, you may need to install T1 Tools Client."
...
**Test Steps:**
1. Run: `C:\T1_Tools_Client\Uninstall.bat`
2. **Expected:**
   ```
   Uninstalling T1 Tools Client...
   Registry entries removed
   Folder deleted: C:\T1_Tools_Client\
   ```
...
### VNC Doesn't Launch
1. Check: `C:\T1_Tools_Client\vncviewer.exe` exists
2. Test URI manually: `Win+R` → `t1vnc://10.110.21.87:5900`
3. Check registry: `regedit` → `HKEY_CLASSES_ROOT\t1vnc`
...
4. ✅ Train users on T1 Tools Client setup
