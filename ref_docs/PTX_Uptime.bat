...
echo:
echo:
plink.exe mms@10.110.19.107 -pw %password% "echo $(date): PTX_Uptime_Report Download Initiated from  %COMPUTERNAME% by %USERNAME%. >> /home/mms/Logs/Report_Download.txt"
