...
## Alternative: Use Existing Tools from AutoTech_Legacy

If you already have these tools in your USB T1_Tools installation:
```
E:\AutoTech_Legacy\bin\putty.exe
E:\AutoTech_Legacy\bin\plink.exe
E:\AutoTech_Legacy\bin\pscp.exe
E:\AutoTech_Legacy\bin\WinSCP.exe
```
